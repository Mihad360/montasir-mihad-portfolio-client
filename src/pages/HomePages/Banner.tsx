...
const Banner = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="w-[500px] h-[300px] bg-gradient-to-r from-[#06B6D4] via-[#06B6D4] to-[#06B6D4] opacity-20 blur-[100px] absolute bottom-0 left-0 z-10 md:block hidden"
        initial={{ opacity: 0 }}
        animate={{ opacity: 0.2 }}
      ...
      <motion.div
        className="w-[500px] h-[300px] bg-gradient-to-r from-[#06B6D4] via-[#06B6D4] to-[#06B6D4] opacity-20 blur-[100px] absolute bottom-[30%] left-1/2 transform -translate-x-1/2 z-10"
        initial={{ opacity: 0 }}
        animate={{ opacity: 0.2 }}
      ...
      <motion.div
        className="w-[500px] h-[300px] bg-gradient-to-r from-[#06B6D4] via-[#06B6D4] to-[#06B6D4] opacity-20 blur-[100px] absolute top-0 right-0 z-10 md:block hidden"
        initial={{ opacity: 0 }}
        animate={{ opacity: 0.2 }}
